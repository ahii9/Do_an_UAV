...
def compute_total_utility(uav_positions, sensor_positions, sensor_types, current_time, t_prev, R,
    ...
    for u in range(num_uav):
        ...
        per_uav_utilities.append({
            'uav_id': u,
            'sensing_util': sensing_util,
            'path_util': path_util,
            'conn_util': conn_util,
            'total_util': utility_u
        })
    ...
    return total_utility, t_prev, collected_sensors, per_uav_utilities
...
if __name__ == "__main__":
    ...
    P_st = 0.005  # Công suất phát của cảm biến (5 mW)
    ...
    SINR_threshold = 2  # Ngưỡng SINR tối thiểu cho liên kết
